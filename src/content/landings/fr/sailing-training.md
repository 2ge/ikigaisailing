---
title: 'Apprends à faire de la voile à San Blas, au Panama'
description: >-
  Stage pratique de voile à San Blas, au Panama — prends la barre d'un Catana 47
  dans les eaux calmes des îles de Guna Yala, en compagnie d'un skipper certifié
  RYA Yachtmaster, et navigue sur de véritables routes de mer entre les
  mouillages.
...
lead: >-
  Apprends à naviguer à San Blas et tu découvriras le terrain d'entraînement le
  plus idéal qu'un marin débutant puisse rêver : des eaux calmes et chaudes, de
  courtes traversées entre les îles, des alizés réguliers et pratiquement aucun
  trafic. Tu prendras la barre d'un Catana 47, tu régleras les voiles, tu
  apprendras à jeter l'ancre dans un lagon turquoise — tout ça grâce à un cours
  pratique dispensé par un RYA Yachtmaster, pas à partir d'un diaporama.
faq:
  - q: Faut-il avoir de l'expérience pour apprendre à faire de la voile ici ?
    a: >-
      Aucun. Les eaux de San Blas sont clémentes — abritées, peu profondes, peu
      fréquentées —, ce qui en fait un endroit idéal pour prendre la barre pour
