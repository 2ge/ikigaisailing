...
summary: >-
  Entrenamientos Tabata cortos e intensos en la terraza o en la playa —20
  segundos de ejercicio, 10 segundos de descanso— con bandas elásticas, TRX,
...
facts:
  - label: Formato
    value: 'Tabata: 20 segundos de ejercicio, 10 segundos de descanso, 8 series'
  - label: Kit
    value: 'Bandas elásticas, TRX, pesas rusas, ejercicios con el propio peso'
  - label: Dónde
    value: En la cubierta o en la playa
  - label: Nivel
    value: >-
...
No necesitas un montón de máquinas para mantenerte fuerte en el mar: solo necesitas tu propio peso, unas cuantas herramientas sencillas y los intervalos adecuados. Entrenamos **al estilo Tabata**: 20 segundos de ejercicio, 10 segundos de descanso, ocho series, repitiendo varios movimientos. Es breve, es intenso y te deja más fresco de lo que lo haría una hora de ejercicio monótono.
