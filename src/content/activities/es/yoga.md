...
facts:
  - label: Nivel
    value: Apto tanto para principiantes como para practicantes avanzados
  - label: Duración de las sesiones
    value: 1 hora
  - label: Tipos de yoga
    value: 'Hatha, Vinyasa y Yin Yoga'
  - label: Ubicación
...
Conecta tu respiración con el movimiento y experimenta la paz interior.
