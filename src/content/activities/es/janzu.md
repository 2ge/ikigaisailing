...
title: Janzu
summary: >-
  El Janzu es una técnica de trabajo corporal acuático: movimientos suaves y
  fluidos en agua templada que liberan la tensión física y emocional y te
  sumergen en un descanso profundo.
seoTitle: Terapia acuática Janzu en un catamarán | Ikigai Sailing
metaDescription: >-
  Sesión de Janzu a bordo de un Catana 47: una terapia acuática personalizada en
  aguas cálidas y tranquilas. Libera la tensión y sumérgete en un descanso
  profundo. Impartido por Sol Naciente.
locale: es
category: wellness
...
facts:
  - label: Duración
    value: Sesiones individuales de aproximadamente 1 hora
  - label: Dónde
    value: Lagunas tranquilas y piscinas naturales
  - label: Ideal para
    value: 'Relajación profunda, estrés, liberación emocional, trabajo con traumas'
  - label: Natación
    value: 'No hace falta: te mantendrán a flote y te ayudarán en todo momento'
  - label: Profesional
    value: 'Formado en Janzu y Wata, lo aprendió de Luca, de Sol Naciente'
translated: deepl
...
Janzu es **una técnica de trabajo corporal acuático**: una práctica individual en la que un terapeuta te hace flotar en agua tibia y mueve tu cuerpo con movimientos lentos y fluidos hasta que tu respiración se calma, tus músculos se relajan y tu mente se tranquiliza. Es muy parecido al **Watsu** y al **Wata**, y se sitúa a medio camino entre el trabajo corporal, la meditación y la terapia. El Janzu se originó en la India, fue desarrollado en México por **Juan Villatoro Garza** y pasó a manos de [Richard Dionne —Sol Naciente—](https://www.facebook.com/sol.naciente.5815/), de quien Luca aprendió las técnicas de primer nivel. Aquí es el agua la que hace el trabajo: sostenido y en ingravidez, el cuerpo libera la tensión que acumula sin que te des cuenta.
