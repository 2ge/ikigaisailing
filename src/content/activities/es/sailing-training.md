...
metaDescription: >-
  ...
  título de RYA Yachtmaster: manejo del timón, ajuste de las velas y guardias,
  todo ello aprendido en travesías reales, allá donde navegue el Ikigai.
locale: es
category: sailing
...
facts:
  - label: Nivel
    value: Desde principiantes totales hasta futuros capitanes
  - label: Al mando
...
La mayor parte de lo que la gente llama «curso de navegación» se hace en un aula. A bordo _del Ikigai,_ se hace en el mar. Es un **Catana 47** —un auténtico catamarán oceánico— y cada trayecto entre fondeaderos es una lección, si así lo quieres. Tomas el timón, ajustas las velas, aprendes a leer el viento en el agua y el tiempo en el horizonte, y haces guardia en los tramos más largos. Nuestro patrón tiene la certificación **RYA Yachtmaster**, así que lo que aprendes es auténtico, enseñado tal y como se hace en la práctica, no a partir de una presentación de diapositivas.
