...
facts:
  - label: Úroveň
    value: Pre začiatočníkov aj pokročilých
  - label: Dĺžka relácie
    value: 2–3 hodiny
  - label: Prístup
    value: 'Relaxačné techniky, dýchanie a cvičenie vo vode'
  - label: Ciele
    value: Zlepšiť svoje zručnosti v statickom a dynamickom freedivingu
  - label: Lektori
...
Objavte, ako freediving posilňuje telo, upokojuje myseľ a zvyšuje uvedomenie. Ten istý pokojný vzťah k dychu a vode sa prenáša priamo do [Janzu](/sk/aktivity/janzu/), vodnej telesnej práce, ktorú praktizujeme na palube.
