---
title: Cómo convertimos el agua de mar en agua potable a bordo del Ikigai Sailing
description: >-
  Descubre cómo Ikigai Sailing transforma el agua de mar en agua potable y con
  gas, viviendo sin conexión a la red eléctrica y reduciendo al mínimo el
...
## **Convertir el agua de mar en agua potable: el primer proceso es la ósmosis inversa**

### **Unidades de desalinización a bordo**

Nuestro sistema se basa en dos **unidades de desalinización**:
...
**De la desalinización a tu vaso: el tratamiento «gourmet»**

### **Grifo de 4 salidas de agua potable**

Para mejorar el sabor y la calidad, el agua pasa por:

-   **Lámpara UV** → elimina las bacterias
-   **Filtro de carbón de 5 micras** → mejora la pureza y el sabor
-   **Filtro mineral** → restaura los minerales naturales
-   **Botella de CO**₂ **+ enfriador** → agua fría y con gas

Toda el agua está disponible a través de un **grifo de 4 salidas**:

1.  Agua para lavar
2.  Agua fría para beber
3.  Agua potable a temperatura ambiente
4.  Agua con gas
...
Una pequeña acción diaria que marca una gran diferencia para el **medio ambiente** y el **océano** que nos acoge.
