---
title: Ako na palube lode Ikigai Sailing premieňame morské vody na pitnú vodu
description: >-
  Zistite, ako spoločnosť Ikigai Sailing premieňa morské vody na pitnú a perlivú
  vodu, pričom funguje nezávisle od verejnej siete a minimalizuje dopad na
  životné prostredie.
locale: sk
pubDate: '2026-01-24'
...
-   **Minerálny filter** → obnovuje prirodzené minerály
-   **Fľaša s CO**₂ **+ chladič** → studená a perlivá voda

Všetka voda je k dispozícii prostredníctvom **4-cestného kohútika**:

1.  Voda na umývanie
2.  Studená pitná voda
...
Malá každodenná činnosť, ktorá má veľký význam pre životné **prostredie** a **oceán,** ktorý nás hostí.
