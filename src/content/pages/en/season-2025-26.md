...
faq:
  ...
  - q: 'What''s it cost, and why is it lower than the agencies?'
    a: >-
      ...
      15–30% cut. Everything's included — meals, every activity and the gear,
      with no add-ons. Agency San Blas charters start far higher. See the season
...
This isn't a fixed-programme retreat — everyone aboard takes part, and the days fill with whatever the group and the weather invite. Mornings often open with [yoga](/panama/san-blas/yoga/), [meditation](/panama/san-blas/meditation/) and conscious breathing at sunrise, then the water: [freediving](/panama/san-blas/freediving/), [snorkelling](/panama/san-blas/snorkelling/) over reefs no day-tour reaches, and [Janzu](/panama/san-blas/janzu/) in the stillest lagoons.

Most days hold a workout too — [functional Tabata training](/panama/san-blas/functional-training/) on deck or the beach: 20 seconds on, 10 seconds off, with resistance bands, TRX, kettlebells and your own bodyweight, no machines in sight. And because *Ikigai* is a sailboat first, there's real [sailing training](/panama/san-blas/sailing-training/) — hands on the helm and the sheets, learning to read the wind.

Between it all we explore deserted islands by kayak and paddleboard, run a [cooking class](/panama/san-blas/cooking-class/) with whatever the sea and the islands give us, sail to remote anchorages, and visit Guna communities to hear their stories. In the water you meet dolphins, nurse sharks and the quiet wonders of a reef left alone.
